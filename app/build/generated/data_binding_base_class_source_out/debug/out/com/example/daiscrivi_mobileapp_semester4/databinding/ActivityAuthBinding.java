...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout frameAuthContainer;

  private ActivityAuthBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout frameAuthContainer) {
    this.rootView = rootView;
    this.frameAuthContainer = frameAuthContainer;
  }
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    FrameLayout frameAuthContainer = (FrameLayout) rootView;

    return new ActivityAuthBinding((FrameLayout) rootView, frameAuthContainer);
  }
}
