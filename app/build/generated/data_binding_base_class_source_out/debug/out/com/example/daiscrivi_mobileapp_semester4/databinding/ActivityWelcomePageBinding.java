...
public final class ActivityWelcomePageBinding implements ViewBinding {
  ...
  private ActivityWelcomePageBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnRegister, @NonNull ImageView tvLogo) {
  ...
  public static ActivityWelcomePageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvLogo;
      ImageView tvLogo = ViewBindings.findChildViewById(rootView, id);
      if (tvLogo == null) {
        break missingId;
      }

      return new ActivityWelcomePageBinding((ConstraintLayout) rootView, btnLogin, btnRegister,
          tvLogo);
    }
