...
public final class FragmentHomeAlbumBinding implements ViewBinding {
  ...
  private FragmentHomeAlbumBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentHomeAlbumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeAlbumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_album, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeAlbumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeAlbumBinding((ScrollView) rootView, photoAnnaTod, photoArianaGodoy,
