...
public final class FragmentHomeFiksiBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHomeFiksiBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentHomeFiksiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHomeFiksiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_home_fiksi, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHomeFiksiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeFiksiBinding((ScrollView) rootView, photoAnnaTod, photoArianaGodoy,
