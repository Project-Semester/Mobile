...
public final class FragmentLibraryBinding implements ViewBinding {
  ...
  private FragmentLibraryBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView4) {
  ...
  public static FragmentLibraryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLibraryBinding((ConstraintLayout) rootView, textView4);
    }
